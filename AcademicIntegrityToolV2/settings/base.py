"""
Django settings for AcademicIntegrityToolV2 project.
...
ROOT_URLCONF = 'AcademicIntegrityToolV2.urls'
...
WSGI_APPLICATION = 'AcademicIntegrityToolV2.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': SECURE_SETTINGS.get('db_default_name', 'AcademicIntegrityToolV2'),
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'AcademicIntegrityToolV2',  # Provide a unique value for shared cache
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'formatter': 'verbose',
            'filename': os.path.join(_LOG_ROOT, 'django-AcademicIntegrityToolV2.log'),
        },
    },
